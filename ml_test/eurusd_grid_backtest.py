...
# ============================================================================
# GRID BACKTEST — EURUSD 5-minute
#
# Architecture:
#   - 15-min eurusd_ranging_regime.py output drives when the grid is ON/OFF
...
#
# P&L reported in pips (PROFIT_PER_POINT=10000 converts price units to pips)
# At 0.01 lots: 1 pip = ~$0.10
# ============================================================================

DATA_5M     = 'data/raw/EURUSD5.csv'
REGIMES_15M = 'data/processed/EURUSD15_regimes.csv'
OUT_PATH    = 'data/processed/eurusd_grid_backtest_results.csv'

# Grid parameters — tune these
GRID_SPACING       = 0.0010   # 10 pips between grid levels
...
PROFIT_PER_POINT   = 10000.0  # converts price units to pips (10 pips per TP)
...
# ============================================================================
print('=' * 70)
print('GRID BACKTEST — EURUSD 5-minute')
...
equity_df.to_csv('data/processed/eurusd_grid_equity_curve.csv', index=False)
print(f'Saved equity curve: data/processed/eurusd_grid_equity_curve.csv')
